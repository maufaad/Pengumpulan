...
class Rapor_SD :
    ...
    def _init_(self,nama, kelas, nilaisikap, nilaiakhir):
        self.nama = nama
        self.kelas = kelas
...
class Kelas_1(Rapor_SD):
    jumlah = 0
    def _init_(self, nama, kelas, nilaisikap, nilaiakhir):
        super()._init_(nama,kelas,nilaisikap,nilaiakhir)
        Kelas_1.jumlah += 1
...
class Kelas_6(Rapor_SD):
    ...
    lulus = 0
    gagal = 0
    def _init_(self,nama,kelas,sikap,nilai,nilaiUN):
        super()._init_(nama,kelas,sikap,nilai)
        self.UN = nilaiUN
        Kelas_6.jumlah += 1
